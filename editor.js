var CDEditor = function (textarea) {
        ...
        var fonts = ['Arial', 'Calibri', 'Comic Sans MS', 'Impact', 'Trebuchet MS', 'Times New Roman', 'Times New Roman'];
        var sizes = [1, 2, 3, 4, 5, 6, 7, 8];
        var colors = ['#000000', '#333333', '#666666', '#999999', '#CCCCCC', '#FFFFFF', '#0000FF',  '#00FF00', 'FF0000', '00FFFF', '#FFFF00', 'FF00FF', '9F009F'
        ];
        var self = this;
       ...
       var ComponentSelect = function (commandName, values) {
        ...
        toolbar.push(
            ...
            new ComponentButton('inserUnorderedList', 'list-ul'),
        );
